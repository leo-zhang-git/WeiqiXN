...
namespace XNClient.ChessBoard
{
    ...
    public static class ChessBoardConfig
    {
        ...
        public const float roadBoderFactor = 0.1f; // 边界道路从中心扩散出的内侧小三角比例，影响道路宽度
        public const float roadNormalFactor = 0.05f;
        public const int starPointSegmentCount = 16;
        public const float starPointRadiusFactor = 0.1f;
